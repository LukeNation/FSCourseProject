...
const {todosUsersController, getUserInfoController, createUserController, updateUserController, updateUserToAdminController, getBoardsFromUsersController, getTaskFromUsersController, usuarioContrasenaController} = require('../controllers/userController')
...
router.post("/info", usuarioContrasenaController)
